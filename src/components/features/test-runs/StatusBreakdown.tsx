...
const statusConfig: Record<StatusKey, { label: string; color: string }> = {
    ...
    automationPassed: { label: 'Automation Passed', color: 'bg-green-600' },
    blocked: { label: 'Blocked', color: 'bg-gray-500' },
    untested: { label: 'Untested', color: 'bg-gray-300 dark:bg-gray-500' },
    skipped: { label: 'Skipped', color: 'bg-yellow-400' },
    failed: { label: 'Failed', color: 'bg-red-500' },
    automationFailed: { label: 'Automation Failed', color: 'bg-red-600' },
    automationError: { label: 'Automation Error', color: 'bg-purple-500' },
};
