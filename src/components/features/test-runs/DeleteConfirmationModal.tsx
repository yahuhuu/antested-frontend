// Path: src/components/features/test-runs/DeleteConfirmationModal.tsx
...
const DeleteConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({ isOpen, onClose, onConfirm, itemCount, itemType }) => {
  if (!isOpen) {
    return null;
  }
        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Are you sure you want to delete {itemCount > 1 ? 'these items' : 'this item'}? This action cannot be undone.
            </p>
          </div>
