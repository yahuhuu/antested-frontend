// Path: components/features/testsuites/DeleteTestSuiteModal.tsx
...
const DeleteTestSuiteModal: React.FC<DeleteTestSuiteModalProps> = ({ isOpen, onClose, onConfirm, suiteName }) => {
  if (!isOpen) {
    return null;
  }
        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Apakah Anda yakin ingin menghapus test suite <span className="font-bold">{suiteName}</span>? Tindakan ini tidak dapat diurungkan.
            </p>
          </div>
...
export default DeleteTestSuiteModal;