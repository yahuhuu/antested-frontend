// Path: src/components/features/admin/projects/DeleteProjectModal.tsx
        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Are you sure you want to permanently delete the project <span className="font-bold">{projectName}</span>? This action cannot be undone and will delete all associated data.
            </p>
          </div>
