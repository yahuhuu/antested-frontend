// Path: src/components/features/test-cases/EditDirectoryModal.tsx
...
const EditDirectoryModal: React.FC<EditDirectoryModalProps> = ({ isOpen, onClose, onSave, initialName }) => {
