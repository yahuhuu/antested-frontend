...
const DeleteTestCaseModal: React.FC<DeleteTestCaseModalProps> = ({ isOpen, onClose, onConfirm, itemCount }) => {
        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              You are about to move <span className="font-bold">{itemCount}</span> test case{itemCount > 1 ? 's' : ''} to the Trash directory. You can restore {itemCount > 1 ? 'them' : 'it'} from there later.
            </p>
          </div>
