// Path: src/components/features/test-cases/DeleteDirectoryModal.tsx
...
const DeleteDirectoryModal: React.FC<DeleteDirectoryModalProps> = ({ isOpen, onClose, onConfirm, directoryName }) => {
  if (!isOpen) {
    return null;
  }
        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Are you sure you want to delete the directory <span className="font-bold">{directoryName}</span>? This will also delete all subdirectories within it. This action cannot be undone.
            </p>
          </div>
