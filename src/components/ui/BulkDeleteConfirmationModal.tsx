// Path: src/components/ui/BulkDeleteConfirmationModal.tsx
...
const BulkDeleteConfirmationModal: React.FC<BulkDeleteConfirmationModalProps> = ({ isOpen, onClose, onConfirm, itemCount, itemType }) => {
        ...
        <div className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">
              Are you sure you want to delete these <span className="font-bold">{itemCount}</span> {itemType}? This action cannot be undone.
            </p>
          </div>
